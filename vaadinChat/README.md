...
- vaadinChat-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadinChat-ui: main application module, development time
- vaadinChat-production: module that produces a production mode WAR for deployment
